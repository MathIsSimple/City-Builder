...
let background_music, shop_bg, trains;
let firstRun = true, fr = 30, grass_img, road_img, road2_img, bg_img, water, solar_panel, track_img, train_img;
let structures = [
  ...
  ["Track",           100,  14,   0,   0,   0,   0,  "None"       ,  0,   0, "Railroad"             ,  0,  0,   0,  50, 0]
];
